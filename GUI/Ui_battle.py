...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.spinBoxBattleCount = QtWidgets.QSpinBox(Dialog)
        self.spinBoxBattleCount.setMinimum(1)
        self.spinBoxBattleCount.setProperty("value", 5)
        self.spinBoxBattleCount.setObjectName("spinBoxBattleCount")
        self.horizontalLayout_4.addWidget(self.spinBoxBattleCount)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_4.setText(_translate("Dialog", "战斗次数"))
